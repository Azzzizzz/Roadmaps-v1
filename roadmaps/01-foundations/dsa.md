...
> 🎯 **Cracking Tier-1 / MAANG?** Use the pattern-based banks — medium/hard questions grouped by algorithmic pattern: [Arrays](dsa/tier1-patterns/arrays-patterns-tier1.md) (90) · [Strings](dsa/tier1-patterns/strings-patterns-tier1.md) (90) · [Linked List](dsa/tier1-patterns/linked-list-patterns-tier1.md) (46) · [Stacks & Queues](dsa/tier1-patterns/stacks-queues-patterns-tier1.md) (37) · [Trees](dsa/tier1-patterns/trees-patterns-tier1.md) (80) · [Graphs](dsa/tier1-patterns/graphs-patterns-tier1.md) (70) · [Heaps](dsa/tier1-patterns/heaps-patterns-tier1.md) (35) · [Recursion & D&C](dsa/foundations/05-recursion-divide-conquer.md) (28) · [Dynamic Programming](dsa/tier1-patterns/dp-patterns-tier1.md) (90) · [Backtracking](dsa/tier1-patterns/backtracking-patterns-tier1.md) (45). **Full 10-topic series complete.**
