...
> 🎯 **Cracking Tier-1 / MAANG?** Use the pattern-based banks — medium/hard questions grouped by algorithmic pattern: [Arrays](dsa-practice/arrays-patterns-tier1.md) (90) · [Strings](dsa-practice/strings-patterns-tier1.md) (90) · [Linked List](dsa-practice/linked-list-patterns-tier1.md) (46). Coming next: stacks-queues → trees → graphs → heaps → dp → backtracking.
